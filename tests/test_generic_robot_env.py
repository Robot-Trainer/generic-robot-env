...
from generic_robot_env import RobotConfig, extract_config_from_xml, GenericRobotEnv
...
<mujoco model="test_robot">
    ...
    <actuator>
        ...
        <position name="gripper_actuator" joint="joint1"/> <!-- Reusing joint for simplicity -->
    </actuator>
    <keyframe>
